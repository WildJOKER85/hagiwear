...
// Email администратора (можно менять)
...
💳 Վճարման եղանակ՝ ${paymentMethod === 'cash' ? 'Կանխիկ' : paymentMethod === 'telcell' ? 'TelCell' : 'Idram'}
...
📦 Պատվեր №${orderId}
💰 Գումար՝ ${totalPrice} ֏
💳 Վճարում՝ ${paymentMethod === 'cash' ? 'Կանխիկ' : paymentMethod === 'telcell' ? 'TelCell' : 'Idram'}
